...
public class DarkPickaxeItem extends QuantumRecomplexModElements.ModElement {
	@ObjectHolder("quantum_recomplex:dark_pickaxe")
	public static final Item block = null;
	public DarkPickaxeItem(QuantumRecomplexModElements instance) {
		super(instance, 12);
	}
