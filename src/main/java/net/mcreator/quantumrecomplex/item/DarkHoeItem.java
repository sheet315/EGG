...
public class DarkHoeItem extends QuantumRecomplexModElements.ModElement {
	@ObjectHolder("quantum_recomplex:dark_hoe")
	public static final Item block = null;
	public DarkHoeItem(QuantumRecomplexModElements instance) {
		super(instance, 16);
	}
