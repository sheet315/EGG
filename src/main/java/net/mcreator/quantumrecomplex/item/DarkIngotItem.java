...
public class DarkIngotItem extends QuantumRecomplexModElements.ModElement {
	@ObjectHolder("quantum_recomplex:dark_ingot")
	public static final Item block = null;
	public DarkIngotItem(QuantumRecomplexModElements instance) {
		super(instance, 6);
	}
